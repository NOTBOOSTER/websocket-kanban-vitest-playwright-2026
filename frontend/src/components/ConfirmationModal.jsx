    ...
    <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 transition-opacity animate-fade-in">
      ...
      >
        ...
        <div className="flex justify-end gap-3 mt-2">
          ...
          <button
            onClick={onConfirm}
            className="confirm-button px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 shadow-md transition-transform transform active:scale-95 text-sm flex items-center gap-2"
          >
